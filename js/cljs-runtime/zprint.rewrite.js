...
var G__40127 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__40127;
continue;
} else {
var G__40128 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40128;
continue;
}
} else {
var G__40129 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40129;
continue;
}
}
...
var G__40099 = zloc;
var G__40100 = (function (){var G__40101 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__40102 = zloc;
var G__40102__$1 = (((G__40102 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__40102) : rewrite_clj.zip.node.call(null,G__40102)));
if((G__40102__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40102__$1) : zprint.zutil.edn_STAR_.call(null,G__40102__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__40101) : rewrite_clj.zip.root.call(null,G__40101));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__40099,G__40100) : rewrite_clj.zip.replace.call(null,G__40099,G__40100));
});
/**
...
var G__40130 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__40130;
continue;
}
break;
...
var G__40131 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__40132 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__40131;
out = G__40132;
continue;
} else {
...
var G__40133 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__40134 = cljs.core.next(new_loc);
var G__40135 = replaced_loc;
nloc = G__40133;
new_loc = G__40134;
last_loc = G__40135;
continue;
...
return zprint.rewrite.sort_val((function (){var G__40118 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__40118) : rewrite_clj.zip.down.call(null,G__40118));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__40119_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__40119_SHARP_) : rewrite_clj.zip.tag.call(null,p1__40119_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__40119_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__40119_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
