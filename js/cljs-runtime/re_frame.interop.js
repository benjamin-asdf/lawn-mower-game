...
return [(function (){var pred__35808 = cljs.core.instance_QMARK_;
var expr__35809 = reactive_val;
if(cljs.core.truth_((pred__35808.cljs$core$IFn$_invoke$arity$2 ? pred__35808.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__35809) : pred__35808.call(null,reagent.ratom.RAtom,expr__35809)))){
return "ra";
} else {
if(cljs.core.truth_((pred__35808.cljs$core$IFn$_invoke$arity$2 ? pred__35808.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__35809) : pred__35808.call(null,reagent.ratom.RCursor,expr__35809)))){
return "rc";
} else {
if(cljs.core.truth_((pred__35808.cljs$core$IFn$_invoke$arity$2 ? pred__35808.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__35809) : pred__35808.call(null,reagent.ratom.Reaction,expr__35809)))){
return "rx";
} else {
if(cljs.core.truth_((pred__35808.cljs$core$IFn$_invoke$arity$2 ? pred__35808.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__35809) : pred__35808.call(null,reagent.ratom.Track,expr__35809)))){
return "tr";
} else {
return "other";
}
