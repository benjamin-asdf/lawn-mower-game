...
var seq__36496 = cljs.core.seq(day8.re_frame_10x.fx.local_storage.all_keys());
var chunk__36497 = null;
var count__36498 = (0);
var i__36499 = (0);
while(true){
if((i__36499 < count__36498)){
var k = chunk__36497.cljs$core$IIndexed$_nth$arity$2(null,i__36499);
...
var G__36522 = seq__36496;
var G__36523 = chunk__36497;
var G__36524 = count__36498;
var G__36525 = (i__36499 + (1));
seq__36496 = G__36522;
chunk__36497 = G__36523;
count__36498 = G__36524;
i__36499 = G__36525;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__36496);
if(temp__5804__auto__){
var seq__36496__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__36496__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__36496__$1);
var G__36526 = cljs.core.chunk_rest(seq__36496__$1);
var G__36527 = c__5565__auto__;
var G__36528 = cljs.core.count(c__5565__auto__);
var G__36529 = (0);
seq__36496 = G__36526;
chunk__36497 = G__36527;
count__36498 = G__36528;
i__36499 = G__36529;
continue;
} else {
var k = cljs.core.first(seq__36496__$1);
if(clojure.string.starts_with_QMARK_(k,day8.re_frame_10x.fx.local_storage.safe_prefix)){
day8.re_frame_10x.fx.local_storage.storage.remove(k);
} else {
}
...
var G__36530 = cljs.core.next(seq__36496__$1);
var G__36531 = null;
var G__36532 = (0);
var G__36533 = (0);
seq__36496 = G__36530;
chunk__36497 = G__36531;
count__36498 = G__36532;
i__36499 = G__36533;
continue;
}
} else {
...
var len__5766__auto___36535 = arguments.length;
var i__5767__auto___36536 = (0);
while(true){
if((i__5767__auto___36536 < len__5766__auto___36535)){
args_arr__5791__auto__.push((arguments[i__5767__auto___36536]));

var G__36537 = (i__5767__auto___36536 + (1));
i__5767__auto___36536 = G__36537;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.fx.local_storage.save.cljs$lang$applyTo = (function (seq36506){
var G__36507 = cljs.core.first(seq36506);
var seq36506__$1 = cljs.core.next(seq36506);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36507,seq36506__$1);
}));

(day8.re_frame_10x.fx.local_storage.save.cljs$lang$maxFixedArity = (1));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_cofx(new cljs.core.Keyword("day8.re-frame-10x.fx.local-storage","load","day8.re-frame-10x.fx.local-storage/load",1482432658),(function (coeffects,p__36513){
var map__36514 = p__36513;
var map__36514__$1 = cljs.core.__destructure_map(map__36514);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36514__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var or = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36514__$1,new cljs.core.Keyword(null,"or","or",235744169));
