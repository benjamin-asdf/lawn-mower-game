...
var syms = (function (){var iter__5520__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__38931(s__38932){
return (new cljs.core.LazySeq(null,(function (){
var s__38932__$1 = s__38932;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__38932__$1);
if(temp__5804__auto__){
var s__38932__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38932__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__38932__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__38934 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__38933 = (0);
while(true){
if((i__38933 < size__5519__auto__)){
var i = cljs.core._nth(c__5518__auto__,i__38933);
...
cljs.core.chunk_append(b__38934,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__38964 = (i__38933 + (1));
i__38933 = G__38964;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38934),rewrite_clj$node$fn$fn_walk_$_iter__38931(cljs.core.chunk_rest(s__38932__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38934),null);
}
} else {
var i = cljs.core.first(s__38932__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__38931(cljs.core.rest(s__38932__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__38930_SHARP_){
var or__5043__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__38930_SHARP_);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return p1__38930_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k38939,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38939,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__38944){
var vec__38945 = p__38944;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38945,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38945,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38938){
var self__ = this;
var G__38938__$1 = this;
return (new cljs.core.RecordIter((0),G__38938__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38940,other38941){
var self__ = this;
var this38940__$1 = this;
return (((!((other38941 == null)))) && ((((this38940__$1.constructor === other38941.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38940__$1.children,other38941.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38940__$1.__extmap,other38941.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k38939){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38939);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__38938){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__38949 = cljs.core.keyword_identical_QMARK_;
var expr__38950 = k__5349__auto__;
if(cljs.core.truth_((pred__38949.cljs$core$IFn$_invoke$arity$2 ? pred__38949.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38950) : pred__38949.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38950)))){
return (new rewrite_clj.node.fn.FnNode(G__38938,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__38938),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__38938){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__38938,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__38942){
var extmap__5382__auto__ = (function (){var G__38952 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38942,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__38942)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38952);
} else {
return G__38952;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38942),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
