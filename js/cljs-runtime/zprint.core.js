...
var vec__41391 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__41394 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41394,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41394,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41391,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41391,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__41405){
var vec__41408 = p__41405;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41408,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41408,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41412,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41412,(1),null);
...
var vec__41419 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41419,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41419,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41419,(2),null);
var vec__41422 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41422,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41422,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41422,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__41426){
var vec__41427 = p__41426;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(1),null);
...
var vec__41435 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41435,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41435,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41435,(2),null);
...
var vec__41442 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41442,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41442,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41442,(2),null);
var tuple = vec__41442;
...
var G__41530 = cljs.core.next(style_vec);
var G__41531 = ends_w_blanks_QMARK_;
var G__41532 = tuple;
var G__41533 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__41530;
previous_ends_w_blanks_QMARK_ = G__41531;
previous_tuple = G__41532;
out = G__41533;
continue;
}
break;
...
var len__5766__auto___41534 = arguments.length;
var i__5767__auto___41535 = (0);
while(true){
if((i__5767__auto___41535 < len__5766__auto___41534)){
args__5772__auto__.push((arguments[i__5767__auto___41535]));

var G__41536 = (i__5767__auto___41535 + (1));
i__5767__auto___41535 = G__41536;
continue;
} else {
}
break;
...
var vec__41448 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41448,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41448,(1),null);
...
var result = (function (){var G__41451 = zprint.core.parse_string_all_options(rest_options);
var G__41452 = zprint.core.zprint_str_internal;
var G__41453 = ":parse-string-all? call";
var G__41454 = (function (){var G__41455 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41455) : zprint.zutil.edn_STAR_.call(null,G__41455));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__41451,G__41452,G__41453,G__41454) : zprint.core.process_multiple_forms.call(null,G__41451,G__41452,G__41453,G__41454));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__41456 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41456,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41456,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq41445){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41446,G__41447,seq41445__$2);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___41541 = arguments.length;
var i__5767__auto___41542 = (0);
while(true){
if((i__5767__auto___41542 < len__5766__auto___41541)){
args__5772__auto__.push((arguments[i__5767__auto___41542]));

var G__41543 = (i__5767__auto___41542 + (1));
i__5767__auto___41542 = G__41543;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq41460){
var G__41461 = cljs.core.first(seq41460);
var seq41460__$1 = cljs.core.next(seq41460);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41461,seq41460__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___41544 = arguments.length;
var i__5767__auto___41545 = (0);
while(true){
if((i__5767__auto___41545 < len__5766__auto___41544)){
args__5772__auto__.push((arguments[i__5767__auto___41545]));

var G__41546 = (i__5767__auto___41545 + (1));
i__5767__auto___41545 = G__41546;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq41462){
var G__41463 = cljs.core.first(seq41462);
var seq41462__$1 = cljs.core.next(seq41462);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41463,seq41462__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___41553 = arguments.length;
var i__5767__auto___41554 = (0);
while(true){
if((i__5767__auto___41554 < len__5766__auto___41553)){
args__5772__auto__.push((arguments[i__5767__auto___41554]));

var G__41557 = (i__5767__auto___41554 + (1));
i__5767__auto___41554 = G__41557;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq41465){
var G__41466 = cljs.core.first(seq41465);
var seq41465__$1 = cljs.core.next(seq41465);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41466,seq41465__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___41558 = arguments.length;
var i__5767__auto___41559 = (0);
while(true){
if((i__5767__auto___41559 < len__5766__auto___41558)){
args__5772__auto__.push((arguments[i__5767__auto___41559]));

var G__41560 = (i__5767__auto___41559 + (1));
i__5767__auto___41559 = G__41560;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq41469){
var G__41470 = cljs.core.first(seq41469);
var seq41469__$1 = cljs.core.next(seq41469);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41470,seq41469__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__41476,form){
var vec__41477 = p__41476;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41477,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41477,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41477,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41477,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__41483 = (cljs.core.truth_((function (){var and__5041__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5041__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41483,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41483,(1),null);
...
var G__41564 = cljs.core.next(sos);
var G__41565 = comment_QMARK_;
var G__41566 = (function (){var or__5043__auto__ = (!(empty_string_QMARK_));
if(or__5043__auto__){
return or__5043__auto__;
} else {
...
var G__41567 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__41564;
previous_comment_QMARK_ = G__41565;
start_interpolating_QMARK_ = G__41566;
out = G__41567;
continue;
}
break;
...
try{var vec__41500 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41500,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41500,(1),null);
...
var vec__41503 = (cljs.core.truth_((function (){var or__5043__auto__ = range_start__$1;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41503,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41503,(1),null);
...
var vec__41506 = (cljs.core.truth_((function (){var and__5041__auto__ = actual_start;
if(cljs.core.truth_(and__5041__auto__)){
return actual_end;
} else {
return and__5041__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41506,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41506,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41506,(2),null);
...
var forms = (function (){var G__41515 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41515) : zprint.zutil.edn_STAR_.call(null,G__41515));
})();
