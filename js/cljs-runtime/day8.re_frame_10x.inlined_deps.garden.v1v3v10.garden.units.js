 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__34680,right){
var map__34681 = p__34680;
var map__34681__$1 = cljs.core.__destructure_map(map__34681);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__34682 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34682,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34682,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34682,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34685__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34686 = u(y);
var map__34686__$1 = cljs.core.__destructure_map(map__34686);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34686__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__34694__delegate = function (x,y,more){
...
var G__34694 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34695__i = 0, G__34695__a = new Array(arguments.length -  2);
while (G__34695__i < G__34695__a.length) {G__34695__a[G__34695__i] = arguments[G__34695__i + 2]; ++G__34695__i;}
  more = new cljs.core.IndexedSeq(G__34695__a,0,null);
} 
return G__34694__delegate.call(this,x,y,more);};
G__34694.cljs$lang$maxFixedArity = 2;
G__34694.cljs$lang$applyTo = (function (arglist__34696){
var x = cljs.core.first(arglist__34696);
arglist__34696 = cljs.core.next(arglist__34696);
var y = cljs.core.first(arglist__34696);
var more = cljs.core.rest(arglist__34696);
return G__34694__delegate(x,y,more);
});
...
var G__34697 = null;
if (arguments.length > 2) {
var G__34698__i = 0, G__34698__a = new Array(arguments.length -  2);
while (G__34698__i < G__34698__a.length) {G__34698__a[G__34698__i] = arguments[G__34698__i + 2]; ++G__34698__i;}
G__34697 = new cljs.core.IndexedSeq(G__34698__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34697);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34687__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34688 = u(y);
var map__34688__$1 = cljs.core.__destructure_map(map__34688);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34688__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__34699__delegate = function (x,y,more){
...
var G__34699 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34700__i = 0, G__34700__a = new Array(arguments.length -  2);
while (G__34700__i < G__34700__a.length) {G__34700__a[G__34700__i] = arguments[G__34700__i + 2]; ++G__34700__i;}
  more = new cljs.core.IndexedSeq(G__34700__a,0,null);
} 
return G__34699__delegate.call(this,x,y,more);};
G__34699.cljs$lang$maxFixedArity = 2;
...
return G__34699__delegate(x,y,more);
});
...
var G__34702 = null;
if (arguments.length > 2) {
var G__34703__i = 0, G__34703__a = new Array(arguments.length -  2);
while (G__34703__i < G__34703__a.length) {G__34703__a[G__34703__i] = arguments[G__34703__i + 2]; ++G__34703__i;}
G__34702 = new cljs.core.IndexedSeq(G__34703__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34702);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34689__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34690 = u(y);
var map__34690__$1 = cljs.core.__destructure_map(map__34690);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34690__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34707);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34691__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34692 = u(y);
var map__34692__$1 = cljs.core.__destructure_map(map__34692);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34692__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__34709__delegate = function (x,y,more){
...
var G__34709 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34710__i = 0, G__34710__a = new Array(arguments.length -  2);
while (G__34710__i < G__34710__a.length) {G__34710__a[G__34710__i] = arguments[G__34710__i + 2]; ++G__34710__i;}
  more = new cljs.core.IndexedSeq(G__34710__a,0,null);
} 
return G__34709__delegate.call(this,x,y,more);};
G__34709.cljs$lang$maxFixedArity = 2;
...
var more = cljs.core.rest(arglist__34711);
return G__34709__delegate(x,y,more);
});
...
var G__34712 = null;
if (arguments.length > 2) {
var G__34713__i = 0, G__34713__a = new Array(arguments.length -  2);
while (G__34713__i < G__34713__a.length) {G__34713__a[G__34713__i] = arguments[G__34713__i + 2]; ++G__34713__i;}
G__34712 = new cljs.core.IndexedSeq(G__34713__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34712);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
