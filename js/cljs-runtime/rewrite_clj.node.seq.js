...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k38986,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__38990 = k38986;
var G__38990__$1 = (((G__38990 instanceof cljs.core.Keyword))?G__38990.fqn:null);
switch (G__38990__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38986,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__38994){
var vec__38995 = p__38994;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38995,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38995,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38985){
var self__ = this;
var G__38985__$1 = this;
return (new cljs.core.RecordIter((0),G__38985__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38987,other38988){
var self__ = this;
var this38987__$1 = this;
return (((!((other38988 == null)))) && ((((this38987__$1.constructor === other38988.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38987__$1.tag,other38988.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38987__$1.wrap_fn,other38988.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38987__$1.wrap_length,other38988.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38987__$1.seq_fn,other38988.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38987__$1.children,other38988.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38987__$1.__extmap,other38988.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__39026 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__39026) : self__.seq_fn.call(null,G__39026));
}));
...
var self__ = this;
var this$__$1 = this;
var G__39037 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__39037) : self__.wrap_fn.call(null,G__39037));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k38986){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38986);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__38985){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__39048 = cljs.core.keyword_identical_QMARK_;
var expr__39049 = k__5349__auto__;
if(cljs.core.truth_((pred__39048.cljs$core$IFn$_invoke$arity$2 ? pred__39048.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__39049) : pred__39048.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__39049)))){
return (new rewrite_clj.node.seq.SeqNode(G__38985,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39048.cljs$core$IFn$_invoke$arity$2 ? pred__39048.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__39049) : pred__39048.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__39049)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__38985,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39048.cljs$core$IFn$_invoke$arity$2 ? pred__39048.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__39049) : pred__39048.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__39049)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__38985,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39048.cljs$core$IFn$_invoke$arity$2 ? pred__39048.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__39049) : pred__39048.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__39049)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__38985,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39048.cljs$core$IFn$_invoke$arity$2 ? pred__39048.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__39049) : pred__39048.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__39049)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__38985,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__38985),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__38985){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__38985,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__38989){
var extmap__5382__auto__ = (function (){var G__39056 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38989,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__38989)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__39056);
} else {
return G__39056;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__38989),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__38989),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__38989),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__38989),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38989),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__39058_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__39058_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__39060_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__39060_SHARP_);
}),children);
});
