...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__38145_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__38145_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__38145_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__38149){
var vec__38150 = p__38149;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38150,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38150,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__38157,s,color,element,idx){
var map__38158 = p__38157;
var map__38158__$1 = cljs.core.__destructure_map(map__38158);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__38162 = (function (){var or__5043__auto__ = color;
...
var fexpr__38161 = (function (){var G__38163 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__38163) : style_map.call(null,G__38163));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__38164){
var vec__38165 = p__38164;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38165,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38165,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38165,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__38168){
var vec__38169 = p__38168;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38169,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38169,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38169,(2),null);
...
var G__38239 = cljs.core.next(ssv);
var G__38240 = (this_ssv == null);
var G__38241 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__38242 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__38239;
doing_nil_QMARK_ = G__38240;
last_elide = G__38241;
out = G__38242;
continue;
}
...
var vec__38180 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38180,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38180,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38180,(2),null);
...
var G__38243 = cljs.core.next(remaining_cvec);
var G__38244 = new_idx;
var G__38245 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__38243;
idx = G__38244;
out = G__38245;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__38193,cursor_vec){
var vec__38194 = p__38193;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38194,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38194,(1),null);
var focus_vec = vec__38194;
...
var vec__38197 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38197,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38197,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__38200){
var vec__38201 = p__38200;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38201,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38201,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__38208,existing_count){
var vec__38210 = p__38208;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38210,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38210,(1),null);
...
return cljs.core.filterv((function (p1__38205_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__38205_SHARP_))));
...
var vec__38217 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38217,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38217,(1),null);
var cvec_element = vec__38217;
if((cvec_element == null)){
var G__38259 = cljs.core.next(cvec_nl);
var G__38260 = (idx + (1));
var G__38261 = start;
var G__38262 = out;
cvec_nl = G__38259;
...
var G__38263 = cljs.core.next(cvec_nl);
var G__38264 = (idx + (1));
var G__38265 = idx;
var G__38266 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__38263;
idx = G__38264;
start = G__38265;
out = G__38266;
...
var G__38267 = cljs.core.next(cvec_nl);
var G__38268 = (idx + (1));
var G__38269 = (idx + (1));
var G__38270 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__38267;
idx = G__38268;
start = G__38269;
out = G__38270;
...
var G__38272 = cljs.core.next(cvec_nl);
var G__38273 = (idx + (1));
var G__38274 = idx;
var G__38275 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__38272;
idx = G__38273;
start = G__38274;
out = G__38275;
...
var G__38276 = cljs.core.next(cvec_nl);
var G__38277 = (idx + (1));
var G__38278 = start;
var G__38279 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__38276;
idx = G__38277;
start = G__38278;
out = G__38279;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__38222_SHARP_,p2__38221_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__38221_SHARP_)){
return cljs.core.reduced(p1__38222_SHARP_);
} else {
return (p1__38222_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__38224,p__38225){
var vec__38226 = p__38224;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38226,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38226,(1),null);
var vec__38229 = p__38225;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38229,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38229,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__38233,cvec,focus_vec){
var map__38235 = p__38233;
var map__38235__$1 = cljs.core.__destructure_map(map__38235);
var options = map__38235__$1;
var map__38236 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38235__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__38236__$1 = cljs.core.__destructure_map(map__38236);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38236__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38236__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38236__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38232_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__38232_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
