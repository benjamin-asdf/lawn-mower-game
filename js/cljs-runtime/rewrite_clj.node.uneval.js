...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k38739,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38739,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__38745){
var vec__38746 = p__38745;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38746,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38746,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38738){
var self__ = this;
var G__38738__$1 = this;
return (new cljs.core.RecordIter((0),G__38738__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38740,other38741){
var self__ = this;
var this38740__$1 = this;
return (((!((other38741 == null)))) && ((((this38740__$1.constructor === other38741.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38740__$1.children,other38741.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38740__$1.__extmap,other38741.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k38739){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38739);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__38738){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__38786 = cljs.core.keyword_identical_QMARK_;
var expr__38787 = k__5349__auto__;
if(cljs.core.truth_((pred__38786.cljs$core$IFn$_invoke$arity$2 ? pred__38786.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38787) : pred__38786.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38787)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__38738,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__38738),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__38738){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__38738,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__38742){
var extmap__5382__auto__ = (function (){var G__38789 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__38742,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38742),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
var G__38826 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38826;
continue;
}
break;
