...
var G__35656 = o;
reagent.impl.template.goog$module$goog$object.set(G__35656,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__35681__i < G__35681__a.length) {G__35681__a[G__35681__i] = arguments[G__35681__i + 0]; ++G__35681__i;}
  args = new cljs.core.IndexedSeq(G__35681__a,0,null);
} 
...
var G__35659 = o;
reagent.impl.template.goog$module$goog$object.set(G__35659,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__35660 = props;
var G__35660__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35660,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35660);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35660__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35662 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35662,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35662;
}
})(),id_class);
...
var G__35663 = (cljs.core.count(argv) - first_child);
switch (G__35663) {
case (0):
...
var vec__35667 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35667,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35667,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35667,(2),null);
...
var temp__5808__auto___35687 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___35687 == null)){
} else {
var key_35688 = temp__5808__auto___35687;
(jsprops.key = key_35688);
}
...
var temp__5808__auto___35691 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___35691 == null)){
} else {
var key_35692 = temp__5808__auto___35691;
(jsprops.key = key_35692);
}
...
var temp__5808__auto___35695 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___35695 == null)){
} else {
var key_35696 = temp__5808__auto___35695;
(jsprops.key = key_35696);
}
...
var temp__5808__auto___35700 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___35700 == null)){
} else {
var key_35701 = temp__5808__auto___35700;
(jsprops.key = key_35701);
}
...
var temp__5808__auto___35705 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___35705 == null)){
} else {
var key_35706 = temp__5808__auto___35705;
(jsprops.key = key_35706);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35670_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__35670_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35671 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35671,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35671,(1),null);
...
break;
default:
var G__35709 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__35710 = compiler;
v = G__35709;
compiler = G__35710;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template35677 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template35677 = (function (opts,id,fn_to_element,parse_fn,meta35678){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template35677.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35679,meta35678__$1){
var self__ = this;
var _35679__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35677(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta35678__$1));
}));

(reagent.impl.template.t_reagent$impl$template35677.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35679){
var self__ = this;
var _35679__$1 = this;
return self__.meta35678;
}));

(reagent.impl.template.t_reagent$impl$template35677.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35677.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35677.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template35677.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35677.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35677.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta35678","meta35678",1741408555,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35677.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35677.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35677");

(reagent.impl.template.t_reagent$impl$template35677.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template35677");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35677.
 */
reagent.impl.template.__GT_t_reagent$impl$template35677 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template35677(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35678){
return (new reagent.impl.template.t_reagent$impl$template35677(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35678));
});

}

return (new reagent.impl.template.t_reagent$impl$template35677(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
