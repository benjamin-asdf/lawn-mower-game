...
if((c === "\n")){
var G__39518 = escape_QMARK_;
var G__39519 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__39518;
lines = G__39519;
continue;
} else {
buf.append(c);

var G__39520 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__39521 = lines;
escape_QMARK_ = G__39520;
lines = G__39521;
continue;
...
var G__39514 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__39514) : rewrite_clj.node.string_node.call(null,G__39514));
});
...
var G__39515 = cljs.core.re_pattern(regex);
var G__39516 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__39515,G__39516) : rewrite_clj.node.token_node.call(null,G__39515,G__39516));
});
