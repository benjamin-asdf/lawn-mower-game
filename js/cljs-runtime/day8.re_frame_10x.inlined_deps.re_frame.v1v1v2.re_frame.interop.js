...
return [(function (){var pred__32092 = cljs.core.instance_QMARK_;
var expr__32093 = reactive_val;
if(cljs.core.truth_((pred__32092.cljs$core$IFn$_invoke$arity$2 ? pred__32092.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__32093) : pred__32092.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__32093)))){
return "ra";
} else {
if(cljs.core.truth_((pred__32092.cljs$core$IFn$_invoke$arity$2 ? pred__32092.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__32093) : pred__32092.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__32093)))){
return "rc";
} else {
if(cljs.core.truth_((pred__32092.cljs$core$IFn$_invoke$arity$2 ? pred__32092.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__32093) : pred__32092.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__32093)))){
return "rx";
} else {
if(cljs.core.truth_((pred__32092.cljs$core$IFn$_invoke$arity$2 ? pred__32092.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__32093) : pred__32092.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__32093)))){
return "tr";
} else {
return "other";
}
